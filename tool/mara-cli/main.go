...
import (
	...
	"github.com/codeclysm/mara-api/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "mara-cli",
		Short: `CLI client for the mara service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:9000", "API hostname")
