...
func CreateCalendarBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CalendarController, payload *app.CreateCalendarPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// CreateCalendarCreated runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func CreateCalendarCreated(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CalendarController, payload *app.CreateCalendarPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func EditCalendarBadRequest(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CalendarController, id string, payload *app.EditCalendarPayload) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func EditCalendarOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.CalendarController, id string, payload *app.EditCalendarPayload) (http.ResponseWriter, *app.MaraAppointment) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
